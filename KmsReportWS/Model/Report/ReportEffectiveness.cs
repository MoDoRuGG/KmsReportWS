...
namespace KmsReportWS.Model.Report
{
    ...
    public class ReportEffectivenessDto
    {
        ...
        public int mee_quantity_plan { get; set; }
        public int mee_quantity_fact { get; set; }
        public decimal mee_quantity_percent { get; set; }
        public int mee_yeild_plan { get; set; }
        public int mee_yeild_fact { get; set; }
        public decimal mee_yeild_percent { get; set; }
        public int ekmp_quantity_plan { get; set; }
        public int ekmp_quantity_fact { get; set; }
        public decimal ekmp_quantity_percent { get; set; }
        public int ekmp_yeild_plan { get; set; }
        public int ekmp_yeild_fact { get; set; }
