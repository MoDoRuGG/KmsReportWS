    ...
    public class ReportCadreHandler : BaseReportHandler
    {
        ...
        public ReportCadreDataDto GetYearData(string yymm, string theme, string fillial)
        {
            ...
            Select(x => new ReportCadreDataDto
            {
                ...
                count_grf17 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf18 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf19 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf20 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf21 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf22 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf23 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf24 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf25 = x.Sum(g => g.count_grf16 ?? 0),
                count_grf26 = x.Sum(g => g.count_grf16 ?? 0),
