...
{
    public class ControlZpz2025Collector
    {
        private readonly string[] _themes = { "Результаты МЭК", "Таблица 6", "Таблица 7", "Таблица 8", "Таблица 9", "Оплата МП" };
        ...
        private readonly string[] _rowNumsExpertiseTable7 =
                ...
                {"6.9", "6.10", "6.10.13", "6.11", "6.12", "6.13", "6.14", "6.15", "6.16", "6.17", "6.18", "6.19", "6.20", "6.21", "6.23", "6.24.9", "6.24.11"};

        public List<CReportZpz2025> Collect(string yymm, bool isMonthly)
        {
            string reportType = isMonthly ? "Zpz2025" : "Zpz_Q2025";
            ...
            var reports = new List<CReportZpz2025>();
        ...
        private ZpzNormative2025 MapNormative(IEnumerable<SummaryZpz2025> zpzFilialData)
        {
        ...
        private ZpzPersonnel2025 MapPersonnel(IEnumerable<SummaryZpz2025> zpzFilialData)
        {
            var zpzTable9 = zpzFilialData.Where(x => x.Theme == "Таблица 9");
            return new ZpzPersonnel2025
            {
        ...
        private ZpzExpertise2025 MapExpertise(IEnumerable<SummaryZpz2025> zpzFilialData)
        {
            var table5Data = zpzFilialData.Where(x => x.Theme == "Результаты МЭК");
            var table6Data = zpzFilialData.Where(x => x.Theme == "Таблица 6");
            var table7Data = zpzFilialData.Where(x => x.Theme == "Таблица 7");
            return new ZpzExpertise2025
            {
                ...
                CountCaseEkmpComplaint = table7Data.Where(x => x.RowNum == "1.9").Sum(x => x.SumVidpom+x.SumVidpomAnother),
                CountCaseEkmpLeth = table7Data.Where(x => x.RowNum == "1.10").Sum(x => x.SumVidpom+x.SumVidpomAnother),
                CountCaseEkmpByMek = table7Data.Where(x => x.RowNum == "1.11").Sum(x => x.SumVidpom+x.SumVidpomAnother),
                CountCaseEkmpByMee = table7Data.Where(x => x.RowNum == "1.12").Sum(x => x.SumVidpom+x.SumVidpomAnother),
                ...
                CountCaseEkmpMultiLeth = table7Data.Where(x => x.RowNum == "3.10").Sum(x => x.SumVidpom+x.SumVidpomAnother),
                CountCaseEkmpMultiUthemeTarget = table7Data.Where(x => x.RowNum == "3.11").Sum(x => x.SumVidpom),
                CountCaseEkmpMultiUthemePlan = table7Data.Where(x => x.RowNum == "3.11").Sum(x => x.SumVidpomAnother),
                CountCaseDefectedBySmoTarget = table7Data.Where(x => x.RowNum == "4").Sum(x => x.SumVidpom),
