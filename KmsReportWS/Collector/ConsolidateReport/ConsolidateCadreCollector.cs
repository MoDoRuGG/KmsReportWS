                ...
                into x
                    select new CReportCadreTable1
                    {
                        ...
                        Data = new ReportCadreDataDto
                        {
                            ...
                            count_grf18 = x.Sum(g => g.table.count_grf16 ?? 0),
                            count_grf19 = x.Sum(g => g.table.count_grf16 ?? 0),
                            count_grf20 = x.Sum(g => g.table.count_grf16 ?? 0),
                            count_grf21 = x.Sum(g => g.table.count_grf16 ?? 0),
                            count_grf22 = x.Sum(g => g.table.count_grf16 ?? 0),
                            count_grf23 = x.Sum(g => g.table.count_grf16 ?? 0),
