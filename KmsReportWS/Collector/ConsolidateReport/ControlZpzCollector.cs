...
namespace KmsReportWS.Collector.ConsolidateReport
{
    public class ControlZpzCollector
    {
        ...
        private readonly string[] _rowNumsExpertiseTable6 = { "5.1", "5.2", "5.3", "5.4", "5.5", "5.6", "5.7", "5.7" };
        ...
        private PgExpertise MapExpertise(IEnumerable<SummaryPg> pgFilialData)
        {
            ...
            return new PgExpertise
            {
                ...
                //DefectMeeTarget = table6Data.Where(x => x.RowNum == "6").Sum(x => x.SumVidpom),
                //DefectMeePlan = table6Data.Where(x => x.RowNum == "6").Sum(x => x.SumVidpomAnother),
