...
namespace KmsReportWS.Collector.ConsolidateReport
{
    public class ControlZpz2025FullCollector
    {
        ...
        public List<CReportZpz2025Full> Collect(string year)
        {
            ...
            foreach (var filial in filials)
            {
                ...
                var report = new CReportZpz2025Full
                {
                    Filial = filial,
        ...
        private List<SummaryZpz2025> CollectSummaryData1Q(string year)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData2Q(string year)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData3Q(string year)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData4Q(string year)
        {
