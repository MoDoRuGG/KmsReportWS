...
namespace KmsReportWS.Collector.ConsolidateReport
{
    public class ViolationsOfAppealsCollector
    {
        private static readonly string[] Statuses = {
            ReportStatus.Submit.GetDescriptionSt(), ReportStatus.Done.GetDescriptionSt(), ReportStatus.Saved.GetDescriptionSt(), ReportStatus.Scan.GetDescriptionSt(), ReportStatus.PartiallyApproved.GetDescriptionSt(),
        };
