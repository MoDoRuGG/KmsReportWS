...
namespace KmsReportWS.Collector.ConsolidateReport
{
    public class ControlZpz2025SingleCollector
    {
        ...
        public List<CReportZpz2025Single> Collect(string year, string filial)
        {
            ...
            var reports = new List<CReportZpz2025Single>();
            ...
            foreach (var fil in filials1Q)
            {
                ...
                var report = new CReportZpz2025Single
                {
                    Filial = fil,
        ...
        private List<SummaryZpz2025> CollectSummaryData1Q(string year, string filial)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData2Q(string year, string filial)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData3Q(string year, string filial)
        {
        ...
        private List<SummaryZpz2025> CollectSummaryData4Q(string year, string filial)
        {
