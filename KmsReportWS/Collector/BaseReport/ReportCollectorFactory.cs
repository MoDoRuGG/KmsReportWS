    ...
    public class ReportCollectorFactory
    {
        ...
        public IReportCollector GetCollector(ReportType reportType) =>
            reportType switch {
                ...
                ReportType.ZpzT1 => new Zpz2025Collector(ReportType.ZpzT1),
                ReportType.ZpzT2 => new Zpz2025Collector(ReportType.ZpzT2),
                ReportType.ZpzT3 => new Zpz2025Collector(ReportType.ZpzT3),
                ReportType.ZpzT4 => new Zpz2025Collector(ReportType.ZpzT4),
